...
glm.hit2 <- glm(hit2 ~ initialPoints, data = BlackJackTrain, family="binomial")
glm.hit3 <- glm(hit3 ~ initialPoints, data = BlackJackTrain, family="binomial")
