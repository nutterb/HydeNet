...
JAGS uses integers to represent levels of factors. Levels of factors are retained as a list element (called `factorRef`) in the output of `compileJagsModel()`. Please see our vignette titled "Obtaining Posterior Distributions for HydeNet Objects"
