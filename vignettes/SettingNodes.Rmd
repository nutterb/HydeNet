...
We have implemented a series of "helper" deterministic functions that we think might be frequently used.  These include `and()` (intersection of binary parent nodes), `or()` (union of parent nodes), and `xor()` (exclusive or of parent nodes).
